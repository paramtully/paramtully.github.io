...
export const experiences: Experience[] = [
    {
        ...
        impactBullets: [
            'Designed and built a reusable CI/CD pipeline with Fastlane automating iOS builds, signing, and App Store deployments, reducing release time from 1 hour to 10 minutes',
