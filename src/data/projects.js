...
const academicProjects = [
    ...
    },
    {
        ...
        date: 'Jan - May 2023',
        description: 'I fully implemented a CI/CD pipeline using GCP supporting 3 build environments, concurrent pushes from 6+ developers, and reduced build and deploy times by 300%. I also contributed to the backend team by choosing our techstack, creating the external design (uml) for the backend, and working implementation details with team members.',
...
const personalProjects = [
    ...
    },
    {
        ...
        roll: null,
        date: 'Dec 2021',
        description: 'A recreation of a game from my childhood. The goal of the game is to break all of the bricks by intercepting the ball with the paddle and redirecting the ball to collide with the bricks. The game incorporated collision detection, random spawning of power-ups which can grant one of three bonuses: paddle extension, slow-mo balls, and multi-ball generation. The game also reduced coupling of score updating by using the observer pattern.',
